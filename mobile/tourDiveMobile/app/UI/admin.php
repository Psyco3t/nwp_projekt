...
{
    header("Location:admin.php?Logins");
}
...
{
    header("Location:admin.php?AgencyView");
}
if(array_key_exists('ManageAgencies', $_POST))
{
    header("Location:admin.php?ManageAgency");
}
if(array_key_exists('add', $_POST))
{
    header("Location:admin.php?AddAgency");
}
if(array_key_exists('add', $_POST))
{
    header("Location:admin.php?AddAgency");
...
{
    header("Location:admin.php?ViewLocation");
}
if(array_key_exists('ViewAttractions', $_POST))
{
    header("Location:admin.php?ViewAttraction");
}
if(array_key_exists('addCity', $_POST))
{
    header("Location:admin.php?addCity");
}
if(array_key_exists('addAttraction', $_POST))
{
    header("Location:admin.php?addAttraction");
}
if(array_key_exists('editAttraction', $_POST))
{
    header("Location:admin.php?editAttraction");
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="../../../../html/assets/css/Navbar-Centered-Brand-icons.css">
...
<body style="background-color: lightgrey">
    ...
    <div style="position: relative; width: fit-content; top:10px ;left: 215px; ">
        ...
        {?>
            <table style="width:auto" id="dataTable" class="display">
                <thead>
                <tr>
                <th>User ID</th>
                <th>browser</th>
    ...
    for($row=0;count($logins)>$row;$row++)
    {
        ...
        echo '</table>';
                ...
                <table style="width: fit-content" class="table">
                    ...
                    {?>
                    <table style="width:auto" class="display" id="dataTable">
                        <thead class="">
                        <tr>
                            <th>ID</th>
                            <th>Agency Name</th>
    ...
    <script src="https://cdn.datatables.net/1.13.6/js/jquery.dataTables.js"></script>
    <script type="text/JavaScript">let table = new DataTable('#dataTable', {
    paging:true
    });</script>
